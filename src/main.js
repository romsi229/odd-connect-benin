...
function initDashboardCharts() {
  ...
  if (lc) chartInstances['lineChart'] = new Chart(lc, {
    ...
    data:{
      labels: MONTHS,
      datasets:[
        { label:'Score ODD', data:SCORE_DATA, borderColor:'#1D9E75', backgroundColor:'rgba(29,158,117,.08)', tension:.4, fill:true, pointRadius:3, pointBackgroundColor:'#1D9E75', borderWidth:2 },
        { label:'Objectif',  data:MONTHS.map((_,i)=>55+i), borderColor:'#185FA5', borderDash:[5,4], pointRadius:0, borderWidth:1.5, fill:false }
      ]
    },
...
function initVeilleChart() {
  ...
  chartInstances['signalChart'] = new Chart(el, {
    type:'doughnut',
    data:{
      labels:['ODD 6 · Eau','ODD 7 · Énergie','ODD 13 · Climat','ODD 14 · Aquatique','ODD 15 · Forêt'],
...
function initMap() {
  ...
  const pts = [
    { lat:6.37,  lng:2.42, title:"Cotonou",        color:"#1D9E75", text:"Projet eau potable" },
    { lat:6.5,   lng:2.62, title:"Porto-Novo",      color:"#1D9E75", text:"Éducation rurale" },
    { lat:9.34,  lng:2.65, title:"Parakou",         color:"#D85A30", text:"🚨 Pénurie eau" },
    { lat:10.3,  lng:1.38, title:"Natitingou",      color:"#E8A000", text:"École sans électricité" },
    { lat:7.18,  lng:1.99, title:"Abomey",          color:"#185FA5", text:"📅 Atelier ODD" },
    { lat:6.95,  lng:2.22, title:"Abomey-Calavi",   color:"#1D9E75", text:"Reboisement" },
    { lat:6.78,  lng:1.98, title:"Lokossa",         color:"#E8A000", text:"Assainissement" },
    { lat:11.12, lng:2.88, title:"Kandi",           color:"#1D9E75", text:"Énergie solaire" },
    { lat:9.75,  lng:1.61, title:"Djougou",         color:"#D85A30", text:"🚨 Déforestation" },
    { lat:7.97,  lng:2.23, title:"Savalou",         color:"#1D9E75", text:"Agriculture durable" },
  ];
